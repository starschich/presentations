...
\begin{frame}{Air clearances}
  \begin{columns}[c,onlytextwidth]
    \begin{column}{0.48\textwidth}
      \centering
      \topoimg[width=\linewidth,height=0.85\textheight,keepaspectratio]{\icfig{m07_image11}}
    \end{column}
    \begin{column}{0.48\textwidth}
      \centering
  ...
  \vspace{0.3em}
  \centering
  {\color{atGray}\footnotesize IEC 60071-1:2019}
\end{frame}
...
\begin{frame}{Faults for overvoltage definition}
  \begin{columns}[c,onlytextwidth]
    \begin{column}{0.4\textwidth}
      \begin{itemize}
        \setlength{\itemsep}{0.4em}
        \item Overvoltages within the converter are defined by converter internal faults.
    ...
    \begin{column}{0.6\textwidth}
      ...
      {\color{atGray}\footnotesize CIGRE 832 --- Guide for Electromagnetic Transient Studies Involving VSC Converters.}
    \end{column}
  \end{columns}
\end{frame}
